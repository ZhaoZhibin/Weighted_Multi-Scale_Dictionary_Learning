...
switch Example_Num
    ...
    case 1
        ...
        printme = @(str) print('-dpdf',sprintf('figures/resonance_demo_1_%s',str));        
    ...
    case 2
        ...
        % Function for printing a figure to a file
        printme = @(str) print('-dpdf',sprintf('figures/resonance_demo_2_%s',str));
...
file_name = sprintf('figures/resonance_demo_%d_info.txt',Example_Num);
