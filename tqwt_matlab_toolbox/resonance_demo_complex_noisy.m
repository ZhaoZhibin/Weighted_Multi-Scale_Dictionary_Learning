...
switch Example_Num
    ...
    case 1
        ...
        printme = @(str) print('-dpdf',sprintf('figures/resonance_demo_complex_noisy_Ex1_%s',str));        
    ...
    case 2
        ...
        % Function for printing a figure to a file
        printme = @(str) print('-dpdf',sprintf('figures/resonance_demo_complex_noisy_Ex2_%s',str));
...
file_name = sprintf('figures/resonance_demo_noisy_complex_Ex%d_info.txt',Example_Num);
