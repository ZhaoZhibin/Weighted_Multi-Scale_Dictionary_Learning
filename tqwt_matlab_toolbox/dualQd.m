function [x1,x2,w1,w2,costfn] = dualQd(x,Q1,r1,J1,Q2,r2,J2,lam1,lam2,mu,Nit,plot_flag)
...
% || x - x1 - x2 ||_2^2 + lam1 ||w1||_1 + lam2 ||w2||_2
...
%
% Use [x1,x2,w1,w2,costfn] = dualQd(...) to return cost function.
%
% Use [...] = dualQd(...,'plots') to plot progress of algorithm (this
...
%
% Algorithm: SALSA-type algorithm for basis pursuit denoising with TQWT.
...
% I. W. Selesnick.
%
% To minimize the cost function, this program uses SALSA, described in:
